...
/* 
CHAVE ESTRANGEIRA É A CHAVE PRIMÁRIA DE UMA TABELA QUE VAI 
ATÉ A OUTRA TABELA PARA FAZER REFERÊNCIA ENTRE
REGISTROS */

/* EM RELACIONAMENTO 1 X 1 A CHAVE ESTRANGEIRA FICA NA TABELA MAIS FRACA */

/* EM RELACIONAMENTO 1 X 1 A CHAVE ESTRANGEIRA FICARÁ SEMPRE NA CARDINALIDADE N*/
...
select count(*) QTD, sexo from cliente group by sexo ;

/* IDS E EMAIL DAS MULHERES QUE MOREM NO CENTRO DO RIO DE JANEIRO E NAO TENHAM CELULAR */

select idcliente, email, nome, sexo, tipo, bairro, cidade
from cliente c 
inner join endereco e 
on c.idcliente = e.id_cliente 
inner join telefone t 
...
vselect nome, email, numero, tipo, estado
from cliente c 
inner join telefone t 
on c.idcliente = t.id_cliente
inner join endereco e  
